...
function createCatppuccinTheme(flavor) {
    ...
    const highlightStyle = HighlightStyle.define([
        ...
        { tag: [tags.url, tags.link], color: colors.teal.hex },
        { tag: [tags.escape, tags.regexp], color: colors.pink.hex },
        { tag: tags.meta, color: colors.overlay0.hex },
        { tag: tags.comment, color: colors.overlay2.hex },
        ...
        { tag: [tags.bool, tags.number], color: colors.peach.hex },
        {
