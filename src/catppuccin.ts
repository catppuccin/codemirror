...
function createCatppuccinTheme(flavor) {
	...
	const highlightStyle = HighlightStyle.define([
		...
		{ tag: [t.definition(t.name), t.separator], color: colors.teal.hex },
		{
			tag: [
				t.typeName,
				t.className,
		...
		{ tag: [t.operator, t.operatorKeyword], color: colors.sky.hex },
		{ tag: [t.url, t.escape, t.regexp, t.link], color: colors.teal.hex },
		{ tag: [t.meta, t.comment], color: colors.overlay0.hex },
...
export const catppuccinFrappe: Extension = createCatppuccinTheme(flavors.frappe)
